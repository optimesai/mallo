...
.partner-master-page {
  --partner-color-page: #f8fafc;
  --partner-color-surface: #ffffff;
  --partner-color-surface-muted: #f1f5f9;
  --partner-color-surface-soft: #eff6ff;
  --partner-color-border: #e2e8f0;
  --partner-color-border-strong: #cbd5e1;
  --partner-color-text-primary: #1e293b;
  --partner-color-text-secondary: #475569;
  --partner-color-text-muted: #94a3b8;
  --partner-color-primary: #1428a0;
  --partner-color-primary-hover: #102180;
  --partner-color-primary-soft: #eef2ff;
  --partner-color-primary-border: #c7d2fe;
  --partner-color-primary-hover-soft: #e0e7ff;
  --partner-color-success: #047857;
  --partner-color-success-soft: #ecfdf5;
  --partner-color-success-border: #bbf7d0;
  --partner-color-warning: #b45309;
  --partner-color-warning-soft: #fffbeb;
  --partner-color-warning-border: #fde68a;
  --partner-color-danger: #dc2626;
  --partner-color-danger-hover: #b91c1c;
  --partner-color-danger-soft: #fff1f2;
  --partner-color-danger-border: #fecdd3;
  --partner-color-danger-hover-soft: #ffe4e6;
  --partner-color-table-divider: #f1f5f9;
  --partner-font-weight-title: 700;
  --partner-font-weight-label: 700;
  --partner-font-weight-strong: 800;
  --partner-font-weight-body: 500;
  --partner-font-weight-muted: 600;
  --partner-radius-panel: 0.75rem;
  --partner-radius-control: 0.5rem;
  --partner-shadow-panel: 0 1px 2px rgb(15 23 42 / 0.06);
