...
export const menuGroups: MenuGroup[] = [
  {
    ...
    items: [{ name: '사용자 및 권한', path: '/system/users' }]
  },
  {
    category: '기준정보 관리',
  ...
  },
  {
    ...
    items: [
      { name: '작업 지시 관리', path: '/production/work-orders' },
      { name: '자재 출고 처리', path: '/production/issue' },
      { name: '공정 실적 관리', path: '/production/executions' }
    ]
  },
  {
    category: '출고 관리',
  ...
  },
  {
    ...
    items: [{ name: 'AI 데이터 챗봇', path: '/ai/queries' }]
  }
]
